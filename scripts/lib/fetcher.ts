/**
 * Rate-limited HTTP client for Bangladeshi legislation from the Sejm ELI API.
 *
...
const USER_AGENT = 'Bangladeshi-Law-MCP/1.0 (https://github.com/Ansvar-Systems/bangladeshi-law-mcp; hello@ansvar.ai)';
