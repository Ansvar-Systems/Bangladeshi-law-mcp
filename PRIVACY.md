...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Bangladeshi bar association rules.
...
- Bangladesh Bar Council (BBC — বাংলাদেশ বার কাউন্সিল) rules require strict confidentiality and data processing controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/bangladeshi-law-mcp` locally — database queries stay on your machine
...
- **Tool Responses**: Statute text (আইনের পাঠ), provision content, search results
...
## Professional Obligations (Bangladesh)

### Bangladesh Bar Council Rules

Advocates in Bangladesh are bound by professional confidentiality rules under the Bangladesh Legal Practitioners and Bar Council Act, 1965 and the Bangladesh Legal Practitioners and Bar Council Order, 1972, administered by the Bangladesh Bar Council (BBC).
...
- Breach of confidentiality may result in disciplinary proceedings before the Bar Council

### Bangladesh Data Protection Considerations

Bangladesh's Digital Security Act, 2018 and the Personal Data Protection Act (pending) impose data handling obligations. When using services that process client data:

- You are responsible as the data handler
...
- Consider data localisation obligations for sensitive client data
...
```
Example: "What does Section 5 of the Contract Act 1872 say about acceptance?"
```
...
```
Example: "What are the penalties for money laundering under the Money Laundering Prevention Act?"
```
...
3. Client matters: Use commercial legal databases with proper agreements
...
2. Follow Bangladesh government IT security requirements
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/Bangladeshi-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **BBC Guidance**: Consult Bangladesh Bar Council ethics guidance on AI tool use
